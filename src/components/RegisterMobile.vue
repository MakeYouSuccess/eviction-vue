  ...
  <div>
    ...
    <v-card class="ma-6 rounded-card">
      ...
      >
        ...
        <div class="mb-6">
          We’ll revolutionize the way you manage your properties and eviction process. Fast. Simple. Painless. Affordable.
        </div>
        ...
        <div
          v-if="errorMsg"
          class="error-message text-left ma-4"
        >
          {{ errorMsg }}
        </div>
