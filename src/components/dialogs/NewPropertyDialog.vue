<template>
  <v-card
    class="pt-12 px-8 secondary--text"
    tile
  >
    ...
    <v-card-subtitle class="secondary--text">
      <span class="font-weight-medium">Instructions:</span> Add your property information here. You may also integrate and import multiple properties here.
    </v-card-subtitle>
    <v-card-text>
      <v-row align-content="center">
        ...
        <v-col class="pt-0">
          ...
          <v-select
            ...
            dense
            background-color="#F0F5F6"
            :items="['Sole Proprietor', 'General Partner of the partnership', 'Limited Liability Company (LLC)', 'Corporation']"
          >
            <v-icon
              slot="append"
              medium
      ...
      <div v-if="property.propertyType">
        <v-row
          v-if="property.propertyType === 'Commercial' || property.propertyType === 'Building'"
        ...
        >
          <v-col>
            ...
            <div class="secondary--text  pb-2">
              Helps identify property. For properties with multiple units, saves time on re-entering property information.
            </div>
            <v-text-field
      ...
      <div class="secondary--text">
        Don’t have one? The courts require that rental properties in the state of New Jersey be registered. This link provides information how to obtain one. Do not delay.
      </div>
      <file-upload class="my-6" />
      <div class="secondary--text font-weight-medium">
        Expiration Date <v-btn
          fab
          color="primary"
          x-small
          height="18"
      ...
      <div class="secondary--text">
        <span class="font-weight-medium">Note: </span> The owner is the person that owns the property, not the person that manages it.
      </div>
      ...
      >
        <span v-if="property.ownershipType === 'Corporation' || property.ownershipType === 'Limited Liability Company (LLC)'">
          <div class="font-weight-medium secondary--text pb-2">Company Name</div>
          <v-text-field
      ...
      <div class="secondary--text">
        <span class="font-weight-medium">Instructions: </span> Unless otherwise indicated, all court correspondence will be sent to the address you have on your <router-link
          class="accent--text no-text-dec font-weight-medium"
          :to="{ name: 'profile'}"
          target="_blank"
        >
          Profile
        </router-link>. You may specify a different mailing address for this property.
      </div>
      <div class="secondary--text font-weight-medium pt-6">
      ...
      >
        ...
        <div>Provide the address to which you would like to receive correspondence.</div>
      ...
      <div class="secondary--text">
        Would you like to apply Group Settings to this property? <v-btn
          fab
          color="primary"
          x-small
          height="18"
