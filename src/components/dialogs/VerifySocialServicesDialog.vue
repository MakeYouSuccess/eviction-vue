    ...
    <v-card-text class="pa-10">
      <div>
        ...
        <div class="secondary--text my-2">
          You are required to mail a copy of the <span class="font-weight-medium">Verified Complaint</span> to the Public Housing office. If this is not the correct address, select “No” and we’ll provide you with a list of offices to select from.
        </div>
        <div
          class="pa-6 mt-12 rounded-card mx-auto"
          style="width: 450px;"
        >
          <div            
            class="mx-auto pa-6 custom-address-card"
          >
            <div
