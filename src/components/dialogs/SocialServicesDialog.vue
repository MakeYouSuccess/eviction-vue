<template>
  ...
  >
    <v-btn
      color="info"
      icon
      class="float-right ma-3 btn--plain"
      @click="close"
    >
              ...
              >
                ...
                <div>
                  <div class="font-weight-bold">
                    {{ office.housingAuthorityWebsite }}
                  </div>
                  ...
                  <div v-if="office.housingAuthorityWebsite === selectedOffice.housingAuthorityWebsite">
                    <div class="font-italic py-2">
                      Address to:
                    </div>
                    <v-text-field
...
export default {
    ...
    created(){
        ...
        .then(data => {
            ...
            this.letterOffices = this.allOffices.filter(o => o.housingAuthorityWebsite && o.housingAuthorityWebsite.startsWith('A'))
            })
    },
    methods:{
        clickLetter(n){
          ...
          this.letter = n
          this.letterOffices = this.allOffices.filter(o => o.housingAuthorityWebsite && o.housingAuthorityWebsite.startsWith(letter))
        },
        submit(){          
