      ...
      >
        ...
        >
          <v-row align="center">
            ...
            <v-col cols="2">
              <div class="headline font-weight-medium pb-1">
                $20
              </div>
              <div
      ...
      >
        ...
        <div class="mt-4 d-flex align-center">
          ...
          <div style="font-size: 0.7rem">
            ...
            >
              Terms and Conditions of the Attorney Client Relationship
            </v-btn>, and agree to the terms.
          </div>
        </div>
        <div
          v-if="acceptError"
        ...
        <div v-if="accept && attorneyId">
          ...
          <div class="d-flex justify-space-around my-8">
            ...
            >
              ...
              <div class="display-2 font-weight-medium pb-6">
                $99
              </div>
              <div
