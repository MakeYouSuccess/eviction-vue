<template>
  <div class="mx-auto secondary--text">
    ...
    >
      ...
      <div class="pb-4">
        Select all of the types of charges you would like to add. We’ll take care of Legal Fees, if applicable, later.
      </div>
...
export default {
    ...
    methods: {
      ...
      next(){
          this.$router.push({name: 'vc-additional-charges-extended', params: {charges: JSON.stringify(this.btns)}})
      },
      typeClicked(item){
