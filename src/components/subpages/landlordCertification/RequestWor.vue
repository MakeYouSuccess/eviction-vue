<template>
  <div class="mx-8 secondary--text">
    ...
    >
      To avoid delay, you can have your request for a <span class="font-weight-medium">Warrant for Removal</span> ready for filing in the event any of the following are entered with the court: <span class="font-weight-medium">Default Judgment, Judgement for Possession, Consent to Enter Judgment and Vacate</span>. Need to make changes based on the judgment rendered by the judge? Not a problem! You can make as many changes as necessary at no additional cost.
    </div>
    ...
    <div v-if="wor">
      ...
      >
        ...
        <div class="text-uppercase font-weight-medium caption">
          MORE INFO
        </div>
      </v-card>
      <div class="py-4">
