<template>
  <div class="mx-8 secondary--text">
    <div
      ...
      style="font-size: .8rem; font-weight: 600; border-bottom: 2px solid #4dccc4; display: inline-block;"
    >
    ...
    >
      Read each option below and select how you would like your attorney to proceed in court, on your behalf.
    </div>
    <div class="font-weight-medium text-left pl-12">
      Select one.
    </div>
    <v-radio-group
      v-model="selected"
      ...
      >
        ...
        <div>
          ...
          <div
            ...
            style="width: 95%; font-size: .85rem"
            class="float-right"
          >
            <div
              v-if="option.id === 0"
            ...
            <div class="my-6">
              ...
              <div>Specify any other terms you would like stipulated in the settlement agreement.</div>
              <v-textarea
                v-model="content"
                class="pt-4"
                hide-details
            ...
            <div class="my-6">
              ...
              <div>If tenant(s) claims the reason for non-payment of rent is due to repairs not being made, please explain your position.</div>
              <v-textarea
                v-model="content"
                class="pt-4"
                hide-details
    ...
    <div
      style="background-color: #FAFBFC; width: 80%; font-size: .9rem"
      class="pa-4 mx-auto"
    >
      <span
        class="font-weight-medium"
        style="border-bottom: solid 2px #4dccc4;"
      >NOTE:</span>
      If an agreement is not reached with the tenant(s), and the case proceeds to trial, you will be required to appear in court.
    </div>
  </div>
</template>
